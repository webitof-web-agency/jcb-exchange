...
test('normalizes legacy API-prefixed public upload URLs before persistence', () => {
  assert.equal(
  ...
  assert.equal(
    normalizePublicUploadUrl('/api/uploads/public/site-logo/logo.webp'),
    '/uploads/public/site-logo/logo.webp',
  );
});
