...
import { Search, Truck, X, Upload, ImagePlus, PlayCircle, Pencil, Trash2, MoreVertical, UserCheck, ChevronDown } from 'lucide-react';
...
export default function PartnerListingsPage() {
  ...
  const openListingDetails = (listing: ListingRecord) => {
    router.push(generateAdminListingDetailPath('/superadmin/listings', listing));
  };
  ...
  const filteredListings = useMemo(() => {
    let scopedListings = listingView === 'pending'
  ...
  }, [listings, listingView, search, availabilityFilter]);
                      ...
                      <td className="px-4 py-3 sm:px-6 sm:py-4 text-right">
                        <div className="relative inline-block text-left action-dropdown-container">
                          ...
                          {openActionDropdownId === listing.id && (
                            <div className="absolute right-0 z-[100] mt-1 w-40 origin-top-right rounded-xl bg-white p-1.5 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.2)] ring-1 ring-black/5 focus:outline-none">
                              {canApprove && isPendingListing ? (
                                <>
                                  <button
                                    ...
                                    className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-emerald-700 hover:bg-emerald-50 disabled:opacity-60"
                                  >
                                    Approve
                                  </button>
                                  <button
                                    ...
                                    disabled={isModeratingListing}
                                    className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-amber-700 hover:bg-amber-50 disabled:opacity-60"
                                  >
                                    Reject
                                  </button>
                                </>
                              ...
                              {canEdit && (
                                <button
                                  ...
                                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900"
                                >
                                  <Pencil size={14} />
                                  Edit
                                </button>
