  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        {/* Card 1 */}
        <div className="bg-white/80 backdrop-blur-xl p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100/80 flex flex-col justify-between transition-all hover:-translate-y-1.5 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:bg-white duration-300">
        ...
        {/* Card 5 */}
        <div className="bg-white/80 backdrop-blur-xl p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100/80 flex flex-col justify-between transition-all hover:-translate-y-1.5 hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:bg-white duration-300 sm:col-span-2 lg:col-span-1 xl:col-span-1">
          <div className="flex items-center justify-between mb-4">
      ...
      <div className="text-center pt-8 pb-4">
        <p className="text-xs font-medium text-gray-400">© 2024 JCB Exchange. All rights reserved.</p>
      </div>
    </div>
  );
}
